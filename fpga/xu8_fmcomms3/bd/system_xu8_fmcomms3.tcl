...
# Hierarchical cell: emio_slicing
proc create_hier_cell_emio_slicing { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_emio_slicing() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -from 15 -to 0 firmware_id
  create_bd_pin -dir O -from 3 -to 0 gpio_ctl
  create_bd_pin -dir O -from 0 -to 0 gpio_en_agc
  create_bd_pin -dir I -from 91 -to 0 gpio_i
  create_bd_pin -dir O -from 91 -to 0 gpio_o
  create_bd_pin -dir O -from 0 -to 0 gpio_resetb
  create_bd_pin -dir I -from 7 -to 0 gpio_status
  create_bd_pin -dir O -from 0 -to 0 gpio_sync
  create_bd_pin -dir O -from 0 -to 0 up_enable
  create_bd_pin -dir O -from 0 -to 0 up_txnrx
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {68} \
 ] $xlconstant_0

  # Create instance: xlslice_emio_43_40, and set properties
  set xlslice_emio_43_40 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_43_40 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {43} \
   CONFIG.DIN_TO {40} \
   CONFIG.DIN_WIDTH {92} \
  ...
  # Create instance: xlslice_emio_44, and set properties
  set xlslice_emio_44 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_44 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {44} \
   CONFIG.DIN_TO {44} \
   CONFIG.DIN_WIDTH {92} \
  ...
  # Create instance: xlslice_emio_45, and set properties
  set xlslice_emio_45 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_45 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {45} \
   CONFIG.DIN_TO {45} \
   CONFIG.DIN_WIDTH {92} \
  ...
  # Create instance: xlslice_emio_46, and set properties
  set xlslice_emio_46 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_46 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {46} \
   CONFIG.DIN_TO {46} \
   CONFIG.DIN_WIDTH {92} \
  ...
  # Create instance: xlslice_emio_47, and set properties
  set xlslice_emio_47 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_47 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {47} \
   CONFIG.DIN_TO {47} \
   CONFIG.DIN_WIDTH {92} \
  ...
  # Create instance: xlslice_emio_48, and set properties
  set xlslice_emio_48 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_emio_48 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {48} \
   CONFIG.DIN_TO {48} \
   CONFIG.DIN_WIDTH {92} \
  ...
  connect_bd_net -net eth_gtx_rst_xlslice_Dout [get_bd_pins up_enable] [get_bd_pins xlslice_emio_47/Dout]
  connect_bd_net -net eth_sys_rst_xlslice_Dout [get_bd_pins up_txnrx] [get_bd_pins xlslice_emio_48/Dout]
  connect_bd_net -net firmware_id_1 [get_bd_pins firmware_id] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net gpio_i_1 [get_bd_pins gpio_i] [get_bd_pins xlslice_emio_43_40/Din] [get_bd_pins xlslice_emio_44/Din] [get_bd_pins xlslice_emio_45/Din] [get_bd_pins xlslice_emio_46/Din] [get_bd_pins xlslice_emio_47/Din] [get_bd_pins xlslice_emio_48/Din]
  connect_bd_net -net gpio_status_1 [get_bd_pins gpio_status] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins gpio_o] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins gpio_en_agc] [get_bd_pins xlslice_emio_44/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins gpio_resetb] [get_bd_pins xlslice_emio_46/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins gpio_sync] [get_bd_pins xlslice_emio_45/Dout]
  connect_bd_net -net xlslice_emio_43_40_Dout [get_bd_pins gpio_ctl] [get_bd_pins xlslice_emio_43_40/Dout]
...
proc create_root_design { parentCell } {
  ...
  set I2C_FPGA [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 I2C_FPGA ]
  ...
  set GPIO_CTL [ create_bd_port -dir O -from 3 -to 0 GPIO_CTL ]
  set GPIO_EN_AGC [ create_bd_port -dir O -from 0 -to 0 GPIO_EN_AGC ]
  set GPIO_RESETB [ create_bd_port -dir O -from 0 -to 0 GPIO_RESETB ]
  set GPIO_STATUS [ create_bd_port -dir I -from 7 -to 0 GPIO_STATUS ]
  set GPIO_SYNC [ create_bd_port -dir O -from 0 -to 0 GPIO_SYNC ]
  ...
  # Create instance: c_counter_user_clk, and set properties
  set c_counter_user_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_counter_binary:12.0 c_counter_user_clk ]
  set_property -dict [ list \
   CONFIG.Output_Width {32} \
 ] $c_counter_user_clk

  # Create instance: emio_slicing
  create_hier_cell_emio_slicing [current_bd_instance .] emio_slicing

  # Create instance: firmware_id, and set properties
  set firmware_id [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 firmware_id ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {8302} \
  ...
  # Create instance: user_clk_xlslice, and set properties
  set user_clk_xlslice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 user_clk_xlslice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {25} \
   CONFIG.DIN_TO {25} \
   CONFIG.DIN_WIDTH {32} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__DIVISOR0 {56} \
  ...
  connect_bd_intf_net -intf_net axi_hp1_interconnect_M00_AXI [get_bd_intf_pins axi_hp1_interconnect/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_hp2_interconnect_M00_AXI [get_bd_intf_pins axi_hp2_interconnect/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HP2_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_IIC_1 [get_bd_intf_ports I2C_FPGA] [get_bd_intf_pins zynq_ultra_ps_e/IIC_1]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_M_AXI_HPM0_LPD [get_bd_intf_pins axi_cpu_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/M_AXI_HPM0_LPD]
  ...
  connect_bd_net -net c_counter_clkref2_Q [get_bd_pins c_counter_user_clk/Q] [get_bd_pins user_clk_xlslice/Din]
  connect_bd_net -net clkref2_xlslice_Dout [get_bd_ports PL_LED2_N] [get_bd_pins user_clk_xlslice/Dout]
  connect_bd_net -net emio_slicing_gpio_ctl [get_bd_ports GPIO_CTL] [get_bd_pins emio_slicing/gpio_ctl]
  connect_bd_net -net emio_slicing_gpio_en_agc [get_bd_ports GPIO_EN_AGC] [get_bd_pins emio_slicing/gpio_en_agc]
  connect_bd_net -net emio_slicing_gpio_o [get_bd_pins emio_slicing/gpio_o] [get_bd_pins zynq_ultra_ps_e/emio_gpio_i]
  connect_bd_net -net emio_slicing_gpio_resetb [get_bd_ports GPIO_RESETB] [get_bd_pins emio_slicing/gpio_resetb]
  connect_bd_net -net emio_slicing_gpio_sync [get_bd_ports GPIO_SYNC] [get_bd_pins emio_slicing/gpio_sync]
  connect_bd_net -net emio_slicing_up_enable [get_bd_pins axi_ad9361/up_enable] [get_bd_pins emio_slicing/up_enable]
  connect_bd_net -net emio_slicing_up_txnrx [get_bd_pins axi_ad9361/up_txnrx] [get_bd_pins emio_slicing/up_txnrx]
  connect_bd_net -net firmware_id_dout [get_bd_pins emio_slicing/firmware_id] [get_bd_pins firmware_id/dout]
  connect_bd_net -net gpio_i_1 [get_bd_pins emio_slicing/gpio_i] [get_bd_pins zynq_ultra_ps_e/emio_gpio_o]
  connect_bd_net -net gpio_status_0_1 [get_bd_ports GPIO_STATUS] [get_bd_pins emio_slicing/gpio_status]
  ...
  connect_bd_net -net spi0_miso_1 [get_bd_ports SPI0_MISO] [get_bd_pins zynq_ultra_ps_e/emio_spi0_m_i]
  connect_bd_net -net sys_250m_clk [get_bd_pins sys_250m_rstgen/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/pl_clk1]
  ...
  connect_bd_net -net sys_500m_clk [get_bd_pins axi_ad9361/delay_clk] [get_bd_pins sys_500m_rstgen/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/pl_clk2]
  ...
  connect_bd_net -net sys_concat_intc_0_dout [get_bd_pins sys_concat_intc_0/dout] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq0]
  connect_bd_net -net sys_concat_intc_1_dout [get_bd_pins sys_concat_intc_1/dout] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq1]
  connect_bd_net -net sys_cpu_clk [get_bd_pins axi_ad9361/s_axi_aclk] [get_bd_pins axi_ad9361_adc_dma/m_dest_axi_aclk] [get_bd_pins axi_ad9361_adc_dma/s_axi_aclk] [get_bd_pins axi_ad9361_dac_dma/m_src_axi_aclk] [get_bd_pins axi_ad9361_dac_dma/s_axi_aclk] [get_bd_pins axi_cpu_interconnect/aclk] [get_bd_pins axi_hp1_interconnect/aclk] [get_bd_pins axi_hp2_interconnect/aclk] [get_bd_pins sys_rstgen/slowest_sync_clk] [get_bd_pins util_ad9361_tdd_sync/clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk0] [get_bd_pins zynq_ultra_ps_e/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  ...
  connect_bd_net -net util_ad9361_divclk_clk_out [get_bd_pins axi_ad9361_adc_dma/fifo_wr_clk] [get_bd_pins axi_ad9361_dac_dma/m_axis_aclk] [get_bd_pins axi_ad9361_dac_fifo/din_clk] [get_bd_pins c_counter_user_clk/CLK] [get_bd_pins util_ad9361_adc_fifo/dout_clk] [get_bd_pins util_ad9361_adc_pack/clk] [get_bd_pins util_ad9361_dac_upack/clk] [get_bd_pins util_ad9361_divclk/clk_out] [get_bd_pins util_ad9361_divclk_reset/slowest_sync_clk]
  ...
  connect_bd_net -net zynq_ultra_ps_e_emio_spi0_m_o [get_bd_ports SPI0_MOSI] [get_bd_pins zynq_ultra_ps_e/emio_spi0_m_o]
  connect_bd_net -net zynq_ultra_ps_e_emio_spi0_sclk_o [get_bd_ports SPI0_SCLK] [get_bd_pins zynq_ultra_ps_e/emio_spi0_sclk_o]
  connect_bd_net -net zynq_ultra_ps_e_emio_spi0_ss1_o_n [get_bd_pins spi0_csn_concat/In1] [get_bd_pins zynq_ultra_ps_e/emio_spi0_ss1_o_n]
  connect_bd_net -net zynq_ultra_ps_e_emio_spi0_ss2_o_n [get_bd_pins spi0_csn_concat/In2] [get_bd_pins zynq_ultra_ps_e/emio_spi0_ss2_o_n]
  connect_bd_net -net zynq_ultra_ps_e_emio_spi0_ss_o_n [get_bd_pins spi0_csn_concat/In0] [get_bd_pins zynq_ultra_ps_e/emio_spi0_ss_o_n]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins sys_250m_rstgen/ext_reset_in] [get_bd_pins sys_500m_rstgen/ext_reset_in] [get_bd_pins sys_rstgen/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_ad9361_adc_dma/m_dest_axi] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_ad9361_dac_dma/m_src_axi] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x9C400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_ad9361_adc_dma/s_axi/axi_lite] -force
  assign_bd_address -offset 0x99020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_ad9361/s_axi/axi_lite] -force
  assign_bd_address -offset 0x9C420000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_ad9361_dac_dma/s_axi/axi_lite] -force
